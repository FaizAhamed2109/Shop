...
<section id="about-head" class="section-p1">
    <img src="./Downloads/about/a6.jpg" alt="">
    <div>
        <h2>Who we are?</h2>
        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
            standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
            a type specimen book.Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
            standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
            a type specimen book.</p>
            <abbr title="">Create stunning images with much or as little control as you like thanks to a choice of Basic and creative modes.</abbr>
    
            <br>
            <br>

            <marquee bgcolor="#ccc" loop="-1" scrollamount="10" width="100%">Create stunning images with much or as little control as you like thanks 
...
<section id="about-app" class="section-p1">
    ...
    <div class="video">
        <video src="./Downloads/about/1.mp4" autoplay muted loop></video>
    </div>
